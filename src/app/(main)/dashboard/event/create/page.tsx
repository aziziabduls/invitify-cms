...
import { RundownManager } from "./_components/rundown-manager"
import { BrandManager } from "./_components/brand-manager"
import { PromoCodeManager } from "./_components/promo-code-manager"
...
export default function CreateEventPage() {
    ...
    async function onSubmit(data: EventFormValues) {
        ...
        try {
            ...
            toast.error("Error creating event. Please try again. " + error);
        } finally {
            setIsLoading(false);
        }
        ...
        <div className="flex flex-1 flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 w-full">
                <div className="space-y-4">
                    <div>
                        <h1 className="text-xl sm:text-2xl font-bold tracking-tight">Create Event</h1>
